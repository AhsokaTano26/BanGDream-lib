...
const REGISTRY = {
    ...
    org: {
        ...
        r: { label: 'Roselia', icon: 'lucide:flower-2', class: 'bg-indigo-50 text-indigo-700 border-indigo-100', isBand: true },
        hhp: { label: 'Hello, Happy World!', icon: 'lucide:smile', class: 'bg-yellow-50 text-yellow-700 border-yellow-100', isBand: true },
